...
public class MouseEventSystem : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetMouseButton(0))
        {
            ...
            else if (DateTime.Now.Subtract((DateTime)_eventStart).TotalMilliseconds > 80)
            {
        ...
        {
            if (DateTime.Now.Subtract((DateTime)_eventStart).TotalMilliseconds > 80)
            {
        ...
        {
            if (DateTime.Now.Subtract((DateTime)_eventStart).TotalMilliseconds <= 120)
            {
